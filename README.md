...
These ground truth sets (labelled and raw images) were used for training a segmentation model using [StarDist](https://github.com/stardist/stardist), in 3D via an in-house developed Jupyter Notebook. A GUI based version of the software for training of the segmentation can be found [here](https://github.com/SFB1158RDM/NucleusAI).
![2](https://github.com/adgpta/NuCLear/assets/77382748/c1e4a16a-5574-4b60-adfb-3daabe800033)


Using the PyRadiomics python package (van Griethuysen, Fedorov et al. 2017), in total 107 radiomics features were extracted for each segmented nucleus after segmentation using StarDist, including, but not limited, to morphological features, intensity features and texture features
