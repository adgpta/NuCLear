...
Automated nuclei segmentation was achieved using the [StarDist](https://github.com/stardist/stardist) which was trained to segment nuclei in 3D using an in-house developed Jupyter Notebook. A GUI based version of the software for training of the segmentation can be found [here](https://github.com/SFB1158RDM/NucleusAI). Using Fiji, ground truth for training were generated by manually labelling and segmenting nuclei.


![2](https://github.com/adgpta/NuCLear/assets/77382748/e461226c-47d1-4aea-81f4-be582c80c6fd)
