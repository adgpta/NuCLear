...
Using the segmentation editor in Fiji, ground truth were generated by manually labelling and segmenting nuclei in 3D as below.
...
We created a GUI version for StarDist, that can be accessed [here](https://github.com/adgpta/NuCLear/tree/main/NuCLearV4.1), we provide also our trained segmentation model and exemplary data. 
